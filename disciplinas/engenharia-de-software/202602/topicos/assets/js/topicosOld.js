/**
 * topico.js
 * Comportamento das páginas de TÓPICO (ex.: topicos/requisitos.html).
 * Vanilla JS, sem dependências externas. Cada recurso é isolado em sua
 * própria função e só é ativado se os elementos correspondentes existirem
 * na página — o mesmo arquivo pode ser reaproveitado em outros tópicos.
 *
...
(function () {
  ...
  /* ------------------------------------------------------------------ */
  /* 5. Marcar tópico como estudado (localStorage)                       */
  /*    Usa a mesma convenção de dados que a home ("Estudado"), então    */
