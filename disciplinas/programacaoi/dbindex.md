...
> Nessa classe importe as bibliotecas java.sql Connection, DriverManager e SQLException
...
> - Em seguida declare a classe e as constantes
>   - URL → local do banco, porta e nome do schema
>   - 127.0.0.1 = máquina local
>   - 3307 = porta do MySQL
>   - meubanco = nome do banco
